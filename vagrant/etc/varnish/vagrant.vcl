# Magento 2.0.5 generated v3.x varnish.vcl modified not to cache phpMyAdmin requests
...
sub vcl_recv {
    ...
    # Vagrant - do not cache phpmyadmin.{{DOMAIN}}
    if (req.http.host == "phpmyadmin.{{DOMAIN}}") {
